   ...
   public static  HashMap<String, Monster> monsters = new HashMap<String, Monster>();
     ...
     public gameMaster()
    {
       ...
       public static void main(String[] args) {
        ...
        while(true){
        System.out.println("Welcome to NoDodolventure");
        System.out.println("An Unbelievable Experience");
        System.out.println("---------------------------");
        System.out.println("Main Menu"); 
        System.out.println("Enter your Game Name('exit' to exit):");
    ...
    gameMaster h = p.gm;
    System.out.println("User Name: " + h.name);
    System.out.println("Lower Damage: "+ h.lowerDamage);
    System.out.println("Upper Damage: "+ h.upperDamage);
    System.out.println("Defense: "+ h.defense);
    System.out.println("hp : "+ h.hp);
    System.out.println("Checker: "+ h.checker);
    System.out.println("day : "+ h.day);
    System.out.println("Monster Damage: "+ h.MonsterDamage);
    System.out.println("Orb Power: "+ h.orbPower);
    System.out.println("Checker For Damage : "+ h.checkerForDamage);
    }
}
